...
3. Choose between TypeScript or JavaScript (default is TypeScript)
4. Name of your Tests folder (default is tests or e2e if you already have a tests folder in your project)
